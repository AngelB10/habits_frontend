<template>
  <aside class="w-80 h-screen bg-[#0f131b] text-white flex flex-col justify-between p-4">
    <div>
      ...
      <div class="mb-8 bg-[#030013] rounded-2xl p-6">
      ...
      <nav class="space-y-1 mb-6 bg-[#030013] rounded-2xl p-6">
        <router-link v-for="(link, i) in links" :key="i":to="link.to" class="flex items-center gap-3 px-4 py-5 rounded hover:bg-gray-700 transition"
